...
?>
<br><br>
<p class="p-center-image"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/teton_peaks_600x300.jpg" alt="about us image" width="250"></p>
...
<p class="p-center-image"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/griz_600x300.jpg" alt="about us image" width="250"></p>

<h5 style="text-align: center;">Attractions:</h5>
<ul>
