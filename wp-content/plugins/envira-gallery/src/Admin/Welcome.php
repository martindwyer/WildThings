...
class Welcome {
	...
	public function enqueue_admin_styles() {
		...
		if ( isset( $_GET['post_type'] ) && isset( $_GET['page'] ) && 'envira' === $_GET['post_type'] && in_array( $_GET['page'], $welcome_pages ) ) {
	...
	public function admin_menu() {
		...
		add_submenu_page(
			...
			__( ( apply_filters( 'envira_whitelabel', false ) ? '' : 'Envira Gallery ' ) . 'Get Started', 'envira-gallery' ),
		...
		add_submenu_page(
			'edit.php?post_type=envira',
			__( ( apply_filters( 'envira_whitelabel', false ) ? '' : 'Envira Gallery ' ) . 'Welcome', 'envira-gallery' ),
		...
		add_submenu_page(
			'edit.php?post_type=envira',
			__( ( apply_filters( 'envira_whitelabel', false ) ? '' : 'Envira Gallery ' ) . 'Changelog', 'envira-gallery' ),
		...
		add_submenu_page(
			'edit.php?post_type=envira',
			__( ( apply_filters( 'envira_whitelabel', false ) ? '' : 'Envira Gallery ' ) . 'Support', 'envira-gallery' ),
	...
	public static function welcome_text() {
		...
		$welcome_text = ( self::is_new_install() )
			? __( 'Thank you for installing Envira! Envira provides great gallery features for your WordPress site!', 'envira-gallery' )
			: __( 'Thank you for updating! Envira %s has many recent improvements that you will enjoy.', 'envira-gallery' );
	...
	public static function tab_navigation( $tab = 'whats_new' ) {
		...
		<h3 class="nav-tab-wrapper">
			<a class="nav-tab 
			<?php
			if ( $_GET['page'] == 'envira-gallery-welcome' ) :
				?>
			...
			<a class="nav-tab 
			<?php
			if ( $_GET['page'] == 'envira-gallery-get-started' ) :
				?>
				nav-tab-active<?php endif; ?>" href="
				<?php
				echo esc_url(
			...
			<a class="nav-tab 
			<?php
			if ( $_GET['page'] == 'envira-gallery-addons' ) :
				?>
				nav-tab-active<?php endif; ?>" href="
				<?php
				echo esc_url(
			...
			<a class="nav-tab 
			<?php
			if ( $_GET['page'] == 'envira-gallery-support' ) :
				?>
				nav-tab-active<?php endif; ?>" href="
				<?php
				echo esc_url(
			...
			<a class="nav-tab 
			<?php
			if ( $_GET['page'] == 'envira-gallery-changelog' ) :
				?>
				nav-tab-active<?php endif; ?>" href="
				<?php
				echo esc_url(
	...
	public function sidebar() {
		...
		?>
			...
			<div class="envira-welcome-sidebar">
				...
				<div class="sidebox">
					<form id="envira-settings-verify-key" method="post" action="<?php echo admin_url( 'edit.php?post_type=envira&page=envira-gallery-settings' ); ?>">
				...
				?>
					<div class="sidebox">
							...
							<p><?php echo sprintf( __( 'Please rate <strong>Envira Gallery</strong> <a href="%1$s" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a> on <a href="%2$s" target="_blank">WordPress.org</a> to help us spread the word. Thank you from the Envira Gallery team!', 'envira-gallery' ), esc_url( $url ), esc_url( $url ) ); ?></p>
				...
				<div class="envira-get-started-panel">
					...
					<div class="wraps about-wsrap">
						...
						<div class="envira-headline-button">
							<a href="<?php echo admin_url( 'post-new.php?post_type=envira' ); ?>" class="button button-primary">
							<?php echo $text; ?></a>
						</div>
	...
	public static function is_new_install() {
		...
		if ( isset( $_GET['is_new_install'] ) && 'true' === strtolower( $_GET['is_new_install'] ) ) {
			return true;
		} elseif ( isset( $_GET['is_new_install'] ) ) {
			return false;
		}
