...
class Envira {
	...
	lightbox() {
		...
		var self = this,
			...
			thumbs = self.get_config('thumbnails') ? { autoStart: thumbs_hide_on_open, hideOnClose: true, position: self.get_lightbox_config('thumbs_position'), rowHeight: self.get_config('thumbnails_height') } : false,
